...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'algebra.data';
      var REMOTE_PACKAGE_BASE = 'algebra.data';
...
Module['FS_createPath']('/examples', 'assets', true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_algebra.data');

      };
      Module['addRunDependency']('datafile_algebra.data');
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 279, "filename": "/examples/assets/CMakeLists.txt"}, {"start": 279, "audio": 0, "end": 296991, "filename": "/examples/assets/arial.ttf"}, {"start": 296991, "audio": 0, "end": 297085, "filename": "/examples/assets/asset.hpp.in"}], "remote_package_size": 297085, "package_uuid": "b321bd91-3632-4fcc-96de-e15a3a2da114"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 147952,
    DYNAMIC_BASE = 5390832,
    DYNAMICTOP_PTR = 147776;
