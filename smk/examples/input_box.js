...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'input_box.data';
      var REMOTE_PACKAGE_BASE = 'input_box.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_input_box.data');

      };
      Module['addRunDependency']('datafile_input_box.data');
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 147728,
    DYNAMIC_BASE = 5390608,
    DYNAMICTOP_PTR = 147552;
...
var wasmBinaryFile = 'input_box.wasm';
