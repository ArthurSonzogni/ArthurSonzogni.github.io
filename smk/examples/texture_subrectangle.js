...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'texture_subrectangle.data';
      var REMOTE_PACKAGE_BASE = 'texture_subrectangle.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_texture_subrectangle.data');

      };
      Module['addRunDependency']('datafile_texture_subrectangle.data');
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 42672,
    DYNAMIC_BASE = 5285552,
    DYNAMICTOP_PTR = 42496;
...
var wasmBinaryFile = 'texture_subrectangle.wasm';
