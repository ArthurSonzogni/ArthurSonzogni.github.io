...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'shader_synnc.data';
      var REMOTE_PACKAGE_BASE = 'shader_synnc.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_shader_synnc.data');

      };
      Module['addRunDependency']('datafile_shader_synnc.data');
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 148864,
    DYNAMIC_BASE = 5391744,
    DYNAMICTOP_PTR = 148688;
...
var wasmBinaryFile = 'shader_synnc.wasm';
