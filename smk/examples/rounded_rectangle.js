...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'rounded_rectangle.data';
      var REMOTE_PACKAGE_BASE = 'rounded_rectangle.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_rounded_rectangle.data');

      };
      Module['addRunDependency']('datafile_rounded_rectangle.data');
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 39408,
    DYNAMIC_BASE = 5282288,
    DYNAMICTOP_PTR = 39232;
...
var wasmBinaryFile = 'rounded_rectangle.wasm';
