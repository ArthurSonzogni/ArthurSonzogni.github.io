...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'vibrate.data';
      var REMOTE_PACKAGE_BASE = 'vibrate.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_vibrate.data');

      };
      Module['addRunDependency']('datafile_vibrate.data');
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 148000,
    DYNAMIC_BASE = 5390880,
    DYNAMICTOP_PTR = 147824;
...
var wasmBinaryFile = 'vibrate.wasm';
