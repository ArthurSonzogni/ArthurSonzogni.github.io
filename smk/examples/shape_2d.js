...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'shape_2d.data';
      var REMOTE_PACKAGE_BASE = 'shape_2d.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_shape_2d.data');

      };
      Module['addRunDependency']('datafile_shape_2d.data');
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 39440,
    DYNAMIC_BASE = 5282320,
    DYNAMICTOP_PTR = 39264;
...
var wasmBinaryFile = 'shape_2d.wasm';
