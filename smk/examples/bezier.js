...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'bezier.data';
      var REMOTE_PACKAGE_BASE = 'bezier.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_bezier.data');

      };
      Module['addRunDependency']('datafile_bezier.data');
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 39472,
    DYNAMIC_BASE = 5282352,
    DYNAMICTOP_PTR = 39296;
