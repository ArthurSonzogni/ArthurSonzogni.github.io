...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_asm_dom_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
Module['wasmTableSize'] = 536;

Module['wasmMaxTableSize'] = 536;
...
Module["asm"] = asm;
var __GLOBAL__sub_I_asm_dom_cpp = Module["__GLOBAL__sub_I_asm_dom_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_asm_dom_cpp"].apply(null, arguments) };
